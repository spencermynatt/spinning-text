	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//all three values will become 0.0f except  w
		                ...
		                //transform matrix       triangle position        position we want
	                        //[ 1, 0, 0,  0,        0.5f,  0.5f, 0.0f,         0.5f    =    (1 * 0.05) + (0 * -0.05) + (0 * 0.0f) + (0 * 1)  
				//  0, 1, 0,  0,    *   0.5f, -0.5f, 0.0f,     *   -0.5f   =    (0 * 0.05) + (1 * -0.05) + (0 * 0.0f) + (0 * 1)  
				//  0, 0, 1,  0,        -0.5f, -0.5f, 0.0f,         0.0f    =    (0 * 0.05) + (0 * -0.05) + (1 * 0.0f) + (0 * 1)  
                              //    0, 0, 0,  1 ]        -0.5f,  0.5f, 0.0f,          1                           1
